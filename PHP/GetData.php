<?php
 ...
 //   }
  ...
  // if ($main <= 0 ) $sql="select name,url,img,typeid,id,kindname from village where recomm=".$recomm_YN ;	
   if ($main <= 0 ) $sql="select name,url,img,typeid,id,pdate,kindname from village where recomm=1" ;	
   if ($main > 0 ) $sql="select name,url,img,typeid,id,kindname from village where typeid=".$main." and subid=".$sub ; 
  // if ($main > 0  && $sub =-2) $sql="select name,url,img,typeid,id,kindname from village where subid=-2' ; 
   if ( strlen($keyword) > 0 ) $sql="select name,url,img,typeid,id,kindname from village where name like '%".$keyword."%'"  ;	
